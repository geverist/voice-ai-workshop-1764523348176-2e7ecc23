# ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ ConversationRelay Starter Pack
...
## ÃÂ°ÃÂÃÂÃÂ From Twilio Voice AI Workshop
...
All your custom work is preserved:
- ÃÂ¢ÃÂÃÂ **System Prompt** (`config/system-prompt.js`) - Your AI's personality
- ÃÂ¢ÃÂÃÂ **Voice Handler** (`handlers/voice-handler.js`) - Your TwiML code
- ÃÂ¢ÃÂÃÂ **WebSocket Handler** (`handlers/websocket-handler.js`) - Your ConversationRelay logic
- ÃÂ¢ÃÂÃÂ **Tools** (`handlers/tools.js`) - Your function calling implementation

---

## ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Quick Start (GitHub Codespaces)
...
## ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Quick Deploy
...
## ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Prerequisites
...
## ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ Architecture
...
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ   Caller    ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Voice Audio ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂºÃÂÃÂ¢ÃÂÃÂÃÂÃÂ   Twilio     ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ   (Phone)   ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ                                    ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ConversationRelayÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ                                    ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
                ...
                ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ  Your Server     ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Text Response ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
                ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ  (WebSocket)     ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
                ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
                    ...
                    Text to LLM
                         ...
                         ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¼
                ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
                ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ   Your LLM       ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
                ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ (OpenAI, Claude, ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
                ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ  Gemini, etc.)   ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
                ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
```

### How It Works

1. **Incoming Call** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Twilio calls your `/voice-handler` endpoint
2. **TwiML Response** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Your server returns ConversationRelay TwiML
3. **WebSocket Connection** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Twilio connects to your WebSocket server
4. **Speech-to-Text** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Twilio (Deepgram) converts caller speech to text ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ sends `prompt` event
5. **AI Processing** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Your server sends text to ANY LLM (OpenAI, Claude, etc.)
6. **Text Response** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Your server sends back text ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Twilio speaks it (ElevenLabs TTS)

## ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ Local Setup
...
1. Go to [Twilio Console ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Phone Numbers](https://console.twilio.com/us1/develop/phone-numbers/manage/incoming)
...
## ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Development Workflow

### Project Structure

```
conversationrelay-starter-pack/
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ server.js                   # Express server + WebSocket setup
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ handlers/
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ   ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ voice-handler.js        # TwiML generation (Step 4)
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ   ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ websocket-handler.js    # ConversationRelay logic (Steps 5-6)
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ   ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tools.js                # Function calling (Step 8)
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ config/
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ   ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ system-prompt.js        # AI personality (Step 7)
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ public/
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ   ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ index.html              # Status dashboard
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ .env                        # Environment variables (DO NOT COMMIT)
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ .env.example                # Example configuration
ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ package.json                # Dependencies
```
...
## ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Production Deployment
...
## ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Conversational Intelligence (Optional)
...
ws.on('close', async () => {
  ...
  if (callSid && process.env.CI_SERVICE_SID) {
    ...
    if (recordings.length > 0) {
      ...
      console.log('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ CI Transcript created');
    }
  }
});
```
...
## ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Security Best Practices
...
## ÃÂÃÂ°ÃÂÃÂÃÂÃÂ§ÃÂÃÂª Testing
...
## ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Resources
...
## ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Troubleshooting
...
- View webhook logs in Twilio Console ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Monitor ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Logs ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Errors
...
## ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¬ Support
...
Built with ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¤ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ using [Twilio ConversationRelay](https://www.twilio.com/docs/voice/conversationrelay), [Deepgram STT](https://deepgram.com/), and [ElevenLabs TTS](https://elevenlabs.io/)
